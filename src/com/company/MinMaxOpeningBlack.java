...
//        File file = new File("./src/com/company/board1.txt");
        ...
        try {
            ...
            display(board);
            board = swap(board);
            MinMaxOpeningBlack mmb = new MinMaxOpeningBlack();
//            char[] bBoard = swap(board);
            Node res = mmb.MinMaxOpeningGame(depth, board);
